...
function tpm:GetOptions()
	EiklasTeleportingTabDB = setmetatable(EiklasTeleportingTabDB or {}, {
		__index = tpm.SettingsBase
	})
	RawSettings = EiklasTeleportingTabDB
	return RawSettings
end
...
function tpm:LoadOptions()
	...
	do
		...
		local function GetOptions()
			...
			container:Add("normal", L["Normal Hearthstone"])
	...
	do -- Font Size Slider
		...
		local function GetValue()
			return EiklasTeleportingTabDB[optionsKey] or defaults[optionsKey]
		end
